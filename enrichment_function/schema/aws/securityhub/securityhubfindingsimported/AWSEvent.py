...
from schema.aws.securityhub.securityhubfindingsimported.SecurityHubFindingsImported import SecurityHubFindingsImported  # noqa: F401,E501

class AWSEvent(object):


    _types = {
        'detail': 'SecurityHubFindingsImported',
        'detail_type': 'str',
        'resources': 'list[str]',
        'id': 'str',
        'source': 'str',
